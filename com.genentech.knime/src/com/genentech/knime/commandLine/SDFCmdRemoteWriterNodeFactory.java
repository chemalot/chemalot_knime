...
/**
 * <code>NodeFactory</code> for the "SDFCmdRemoteWriter" Node.
 * Compile and execute the unix command, write output on server
 *
 * @author Man-Ling Lee, Genentech
 */
public class SDFCmdRemoteWriterNodeFactory extends NodeFactory<AbstractCommandNodeModel> {
    ...
    public AbstractCommandNodeModel createNodeModel() {
        return new SDFCmdRemoteWriterNodeModel();
    }
    ...
    public NodeView<AbstractCommandNodeModel> createNodeView(final int viewIndex,
        ...
        if( viewIndex == 0)
            return new SDFCmdRemoteWriterNodeView((SDFCmdRemoteWriterNodeModel) nodeModel);
        else 
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new SDFCmdRemoteWriterNodeDialog();
    }
