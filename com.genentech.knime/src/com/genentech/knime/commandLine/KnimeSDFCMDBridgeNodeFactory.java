...
/**
 * <code>NodeFactory</code> for the "Knime to SDF Command Bridge" Node.
 *
 * @author AG
 */
public class KnimeSDFCMDBridgeNodeFactory extends NodeFactory<AbstractCommandNodeModel> {
    ...
    public AbstractCommandNodeModel createNodeModel() {
        return new KnimeSDFCMDBridgeNodeModel();
    }
    ...
    public NodeDialogPane createNodeDialogPane() {
        return new KnimeSDFCMDBridgeNodeDialogPane();
    }
