...
/**
 * {@link NodeSetFactory} for command line nodes with one input and one output port.
 * 
 * @author Bernd Wiswedel, KNIME.com, Zurich, Switzerland
 */
public class ProcessorCmdSdfNodeSetFactory extends AbstractCmdSdfNodeSetFactory {

    /**
     *  */
    public ProcessorCmdSdfNodeSetFactory() {
        super(CommandType.PROCESSOR);
    }
    ...
    public Class<? extends NodeFactory<? extends NodeModel>> getNodeFactory(
            final String id) {
        return (Class<? extends NodeFactory<? extends NodeModel>>)ProcessorCmdSdfNodeFactory.class;
    }
