...
/**
 * {@link NodeDialogPane} for command line nodes with one input port.
 * 
 * @author albertgo
 *
 */
public class ConsumerNodeDialogPane extends NodeDialogPane {
	 ...
	 * comment.
	 */
	public ConsumerNodeDialogPane(final CMDProgramDefinition programDefinition) {
	...
	protected void saveSettingsTo(final NodeSettingsWO settings)
	    ...
	    NodeSettingsWO cmdSettings = settings.addNodeSettings(ConsumerCmdSdfNodeModel.CMD_CONFIGURATION_NAME);
	...
	protected void loadSettingsFrom(final NodeSettingsRO settings,
        ...
        try {
            cmdSettings = settings.getNodeSettings(ConsumerCmdSdfNodeModel.CMD_CONFIGURATION_NAME);
