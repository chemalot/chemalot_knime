...
/**
 * {@link NodeFactory} for command line nodes with one input.
 * 
 * @author albertgo
 *
 */
public class ConsumerCmdSdfNodeFactory extends AbstractCmdSdfNodeFactory {


    /** {@inheritDoc} */
    @Override
    protected NodeDialogPane createNodeDialogPane() {
        return new ConsumerNodeDialogPane(getCMDProgramDefinition());
    }


    /** {@inheritDoc} */
    @Override
    public ConsumerCmdSdfNodeModel createNodeModel() {
        return new ConsumerCmdSdfNodeModel(getCMDProgramDefinition());
    }
}
