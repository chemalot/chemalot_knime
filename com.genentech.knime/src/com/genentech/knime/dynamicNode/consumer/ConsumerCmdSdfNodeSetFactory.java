...
/**
 * {@link NodeSetFactory} for command line nodes with one input port.
 * 
 * @author Bernd Wiswedel, KNIME.com, Zurich, Switzerland
 */
public class ConsumerCmdSdfNodeSetFactory extends AbstractCmdSdfNodeSetFactory {

    /**
     *  */
    public ConsumerCmdSdfNodeSetFactory() {
        super(CommandType.CONSUMER); //ML DONE: replaced "PROCESSOR"
    }
    ...
    public Class<? extends NodeFactory<? extends NodeModel>> getNodeFactory(
            final String id) {
        return (Class<? extends NodeFactory<? extends NodeModel>>)ConsumerCmdSdfNodeFactory.class;
    }
